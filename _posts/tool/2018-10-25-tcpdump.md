...
### 网址:
- 参考博客: [http://www.cnblogs.com/f-ck-need-u/p/7064286.html](http://www.cnblogs.com/f-ck-need-u/p/7064286.html)
...
![tcpdump_fmt](/assets/img/tool/tcpdump/tcpdump_fmt.png)
...
(14).更多举例：
```
tcpdump -XX -vvv -nn -i any tcp dst port 17823

tcpdump -XX -vvv -nn -i any src 59.37.125.42
```
